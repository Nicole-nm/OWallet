export default {
  common: {
    ...
    password: 'Password',
    invalidLedger:
      'The current ledger dose not match with the wallet.Please try with another ledger device.',
    ...
    currentlyLatestVersion: 'You are already on the latest version.',
    ...
    changePassSuccessTip:
      'You have already changed the password of the wallet. We recommend you to download and backup the .dat file.(Please replace or delete the old .dat file of this wallet.)',
    ...
    savedbFailed:
      'Save to db file failed.Please make sure you have set the path to save the keystore.db file and try again.',
    selectOep4: 'Select OEP-4 token',
    contractHash: 'Contract hash: ',
    txFailed: 'Transaction failed',
    availableNewVersion:
      'A new version is available. In order to get a better user experience, please upgrade OWallet.',
    toUpdate: 'Upgrade now',
    cancel: 'Cancel',
    retry: 'Retry',
    transactionFailed: 'Transaction failed',
    transactionHashPrefix: 'Transaction hash: ',
    rejectedByUser: 'Rejected by user',
    dbLoadErr: 'Cannot find the keystore.db file. Please set the keystore.db file path.',
  },
  ...
  validation: {
    ...
    exactLength: '{field} must be {length} characters',
  ...
  identities: {
    ...
    identity: 'Identity',
    ontid: 'ONT ID',
    loadingIdentities: 'Loading ONT IDs',
    loadFailed: 'ONT IDs could not be loaded',
    emptyIdentities: 'No ONT IDs yet',
    emptyIdentityDescription: 'Create or import an ONT ID to get started.',
  },
  ...
  createIdentity: {
    ...
    setupIdentityStep: 'Set up ONT ID',
    reviewIdentityStep: 'Review ONT ID',
  ...
  wallets: {
    ...
    loadFailed: 'Wallets could not be loaded',
    loadFailedDescription: 'Check the keystore path and try again.',
    emptyCommonWallets: 'No individual wallets yet',
    emptySharedWallets: 'No shared wallets yet',
    emptyLedgerWallets: 'No Ledger wallets yet',
    emptyWalletDescription: 'Create or import a wallet to get started.',
    emptyCommonWalletDescription: 'Create or import a wallet to get started.',
    emptySharedWalletDescription: 'Create or join a shared wallet to get started.',
    emptyLedgerWalletDescription: 'Connect Ledger to get started.',
    ...
    filterPlaceholder: 'Search wallets or addresses',
  ...
  createJsonWallet: {
    ...
    details: '',
    confirmInfo: 'Confirm info',
    backupWalletStep: 'Back up wallet',
    labelN: 'Label',
    addressN: 'Address',
    pubKeyN: 'Public key',
    ...
    privateKey: 'Private Key',
    backupWallet:
      'Please make a backup of the above information and save the .dat file. If you forget your wallet password, your private key (WIF) will be the only way for you to recover your wallet.',
  ...
  importJsonWallet: {
    ...
    importDatSuccessOne: 'A total of {count} address was imported successfully.',
    importDatSuccessMany: 'A total of {count} addresses were imported successfully.',
  ...
  createSharedWallet: {
    basicInfo: 'Basic info',
    addCopayersStep: 'Add co-payers',
    signatureRuleStep: 'Set signature rule',
    copayers: 'Co-payers',
  ...
  importSharedWallet: {
    ...
    basicInfo: 'Basic info',
    findWalletStep: 'Find shared wallet',
    confirmJoinStep: 'Confirm join',
  ...
  commonWalletHome: {
    ...
    submit: 'Submit',
    swapText:
      'Here you can perform the MainNet ONT token swap.Users can exchange Nep-5 ONT for ONT for ONT on the Ontology MainNet.Swap takes up to 1 month, you can check the status on https://swap.ont.io',
  ...
  transfer: {
    ...
    warningTransferAllONG:
      'Transferring this amount of ONG means you will not have enough ONG to pay\r\nfor further transaction fees (including claiming unbound ONG). \r\n\r\nContinue?',
  },
  ...
  setting: {
    ...
    preferencesCopy: 'Manage network, node, and appearance.',
    net: 'Network',
    networkCopy: 'Choose the network used across the app.',
    storage: 'Storage',
    storageCopy: 'Choose where the encrypted keystore database is stored.',
    storagePathLabel: 'Keystore path',
    lang: 'Language',
    testNet: 'TestNet',
    mainNet: 'MainNet',
    en: 'English',
    ...
    settings: 'Settings',
    theme: 'Theme',
    themeCopy: 'Set the interface appearance.',
    lightTheme: 'Light',
    darkTheme: 'Dark',
    systemTheme: 'Follow System',
    updates: 'Updates',
    updatesCopy: 'Review your version status and install a newer release when needed.',
    updateStatusUnknown: 'Not checked',
    updateStatusChecking: 'Checking',
    updateStatusLatest: 'Up to date',
    updateStatusAvailable: 'Update available',
    updateStatusFailed: 'Check failed',
    updateSummaryUnknown: 'Check for updates to see whether a newer release is available.',
    updateSummaryChecking: 'Checking the latest release information.',
    nodeAddress: 'Node address',
    nodeCopy: 'Select the node used for requests and chain data.',
    setNodeSuccess: 'The node address has been set to: ',
  ...
  ledgerWallet: {
    ...
    appClosed: 'Your ONT app is closed! Please login.',
    transactionTooBig: 'Your transaction is too big for the ledger to sign!',
    transactionDenied: 'You have denied the transaction on your ledger.',
    ...
    loadingAccounts: 'Loading addresses from your Ledger device...',
    retryingAccounts: 'Retrying to load addresses from your Ledger device...',
  },
  ...
  nodeStake: {
    ...
    quitWarmMsg:
      'If you choose to quit the node, all the initial staked amount will be returned. The candidate node can get the staked amount returned after one cycle, and the consensus node can get it returned after two cycles. After quitting the node, if you want to run a node again, you have to sign up again.',
    back: 'Back',
    recall: 'Recall',
    refund: 'Refund',
    quitNode: 'Quit Node',
  ...
  redeemInfo: {
    ...
    noClaimableOng:
      'Your claimable ONG is 0. When a transaction of ONT is made in your address, the claimable ONG balance will update',
  },
  ...
  nodeMgmt: {
    ...
    rewardsTip:
      'Estimate total rewards per month includes your rewards and the rewards of other uesrs staking.',
    rewardProportion: 'Fee Sharing Ratio ',
    nodeRewardProportion: 'Fee Sharing Ratio (Node)',
    userRewardProportion: 'Fee Sharing Ratio (User)',
    current: 'current',
    nodeRewardProportionTip:
      'Fee Sharing Ratio (Node): Node will receive x percentage of the transaction fees and released ONG yield of the total amount of node’s own initial ONT stake (excl. ONT staked by users).',
    userRewardProportionTip:
      'Fee Sharing Ratio (User): Node will receive x percentage of the transaction fees and released ONG yield of the total amount of ONT staked by users (excl. node’s own initial stake).',
    confirm: 'Confirm',
    changesTakeEffect:
      ' Changes will take effect in two consensus rounds (each round is approximately every 30 days). ',
    stakeAuthorization: 'Stake Authorization',
    toNextRound: 'Next round in',
    rank: 'Rank',
    name: 'Name',
    checkmark: 'Checkmark',
    checkmarkTip: 'Checkmarks label noteworthy node attributes and risk signals in the node list.',
    checkmarkDetails: 'View details of node checkmark',
    stableFeeSharingRatio: 'Stable fee sharing ratio',
    ontologyHarbinger: 'Ontology Harbinger',
    badActor: 'Bad actor',
    alert: 'Alert',
    currentStake: 'Total Stake',
    annualizedYield: 'Annualized Yield',
    annualizedYieldTip:
      'This estimated data is calculated according to real-time network operation, staking status, and ONT/ONG price.',
    ...
    notLessTotalPosTenth:
      'Allowed user stake cannot be less than 1/10 of the current total stake of users.',
    refresh: 'Refresh',
    totalStakeAmount: 'Total Authorization Amount',
    block: 'Block',
    blocks: 'Blocks',
    proportionNextRound: 'Fee Sharing Ratio',
    proportionNextRoundTip:
      'This is the percentage of the transactions fees and released ONG yield of the total amount of stake yield for node’s own initial stake and the total user’s stake, that the node has chosen to share with their stakers in the next consensus round.\nPlease note that not all nodes share the Ontology Foundation bonus with stakers. Click the below link for more details.',
...
`,
    unboundOng: 'Unbound',
    activeT: 'Active in the current round',
    activeT1: 'Active in the next round',
    activeT2: 'Active in the round after next',
    ...
    lockedONT:
      'This is your canceled authorized stake amount currently held in a smart contract. Once it is available to be withdrawn, it will appear as redeemable ONT.',
    unboundONG: 'This is the unbound ONG amount of your authorized ONT stake.',
    profitONG:
      'This is the transaction fee profit you have made. This will update at the beginning of each new consensus round.',
    getProfitPart: 'Earning stake',
    newStakePart: 'Pending stake',
  ...
  nodeApply: {
    newNodeApply: 'New node apply',
    configureNodeStep: 'Configure node',
    reviewApplicationStep: 'Review application',
    ...
    ontBalanceInsufficient: 'Insufficient ONT balance for staking.',
    ongBalanceInsufficient:
      'Insufficient ONG balance. Stake wallet needs at least 500 ONG fee plus transaction fee.',
    ...
    unsupportedLedger:
      'Ledger hardware wallet is currently not supported as operation wallet for node registration.',
  },
  myNode: {
    myNode: 'My nodes',
    stakeWalletAddress: 'Stake wallet address',
  ...
  nodeInfo: {
    ...
    twitter: 'X',
    enterTwitter: 'X of node',
    facebook: 'Facebook',
    enterFacebook: 'Facebook',
    contactOntologyEmail: 'Contact',
    enterContactEmail: 'Email to contact Ontology',
    openEmail: 'Email',
    enterOpenEmail: 'Email to public',
    ifOpenInfo: 'Switch to open info',
    sectionIdentity: 'Identity',
    sectionLinksContact: 'Links & contact',
    visibilityTitle: 'Public visibility',
    visibilityDesc: 'When enabled, the details above are visible to everyone browsing nodes.',
    submit: 'Submit',
    updateSuccess: 'Update node info succeed',
    updateFailed: 'Update node info failed',
    ledgerWalletNotSupportForNow:
      'Nodes registered with ledger currently do not support updating node-related information. Please email to: ',
  },
  exchange: {
    exchange: 'Exchange',
    changelly: 'Changelly',
