...
import { reverseHex, str2hexstr } from '../../shared/chain/sdkHex'
import { serializeTx } from '../transaction/serializationService'
import { createRegisterCandidateTransaction } from './governanceDomainService'
...
export function createDelegatedStakeTransactionBody({
  ...
  return {
    ...
    transactionhash: reverseHex(tx.getHash()),
    transactionbodyhash: serializeTx(tx, 'transaction.serializeTransaction'),
  }
}
